...
public class CarPmProcedure implements Serializable {
    private String id;
    ...
    public void setEntrustContractNo(String entrustContractNo) {
        this.entrustContractNo = entrustContractNo == null ? null : entrustContractNo.trim();
    }
    ...
    public void setHandoverBillNo(String handoverBillNo) {
        this.handoverBillNo = handoverBillNo == null ? null : handoverBillNo.trim();
    }
